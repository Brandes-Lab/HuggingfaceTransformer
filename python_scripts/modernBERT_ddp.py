...
class EvalTimingCallback(TrainerCallback):
    ...
    def on_evaluate_end(self, args, state, control, **kwargs):
        ...
        print(f"[Eval Timing] Evaluation took {elapsed:.2f} seconds ({elapsed/60:.2f} minutes)")
...
def main():
    ...
    # trainer.add_callback(EvalTimingCallback())
