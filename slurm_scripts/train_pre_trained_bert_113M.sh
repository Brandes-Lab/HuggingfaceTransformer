#!/bin/bash
#SBATCH --job-name=train_pre_trained_modernBERT_113M_2
...
torchrun \
    ...
    --run-name pre_trained_modernBERT_113M_2 \
    ...
    --ckpt_path /gpfs/data/brandeslab/model_checkpts/pre_trained_modernBERT_113M/checkpoint-230000 \
    --eval_strategy "no" \
    --save_steps 10_000 \
    --dynamic-batching  
