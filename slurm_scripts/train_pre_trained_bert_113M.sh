#!/bin/bash
#SBATCH --job-name=train_pre_trained_modernBERT_113M
...
torchrun \
    ...
    --run-name pre_trained_modernBERT_113M \
    ...
    --ckpt_path /gpfs/data/brandeslab/model_checkpts/modernBERT_113M/checkpoint-20000 \
    --eval_strategy "no" \
    --save_steps 10_000  
