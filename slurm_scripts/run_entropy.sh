#!/bin/bash
#SBATCH --job-name=VEP_score_range
#SBATCH --partition=a100_short
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=100G
#SBATCH --time=20:00:00
#SBATCH --output=VEP_score_range_%j.out
#SBATCH --error=VEP_score_range_%j.err
...
python python_scripts/entropy.py \
    ...
    --output_csv /gpfs/home/rm7569/HuggingfaceTransformer/clinvar_full_dist_entropy.csv \
    --start_step 400 \
    --end_step 6000 \
    --step_size 400 \
    --batch_size 8 \
