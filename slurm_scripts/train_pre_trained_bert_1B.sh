#!/bin/bash
#SBATCH --job-name=train_pre_trained_modernBERT_1B
...
torchrun \
    ...
    --run-name pre_trained_modernBERT_1B \
    ...
    --ckpt_path /gpfs/data/brandeslab/model_checkpts/modernBERT_1B/checkpoint-3000 \
    --eval_strategy "no" \
    --save_steps 1500
